...
The mod is still in active development. Everything in this guide is written for the `v0.6.0-alpha.1` release.
Join the [Archipelago Discord server] for technical support, development updates, or to contribute!
<!-- placeholder link -->
...
1. Most item locations are randomized, including those in the overworld, in
   shops, and dropped by enemies. Randomized locations can contain items from other
   worlds, and any items from your world can appear in other players' worlds. Details for
   what is and isn't randomized is explained in [this section](##Are-there-items-that-aren't-randomized?).
...
rewards from NPC quests, items stocked into NPC shops, enemy and boss drops, and more. <!--TODO: MORE?-->

~ maybe explain ItemClassification enums?
...
For example, the following configuration requires you to only play through main areas:
...
Dark Souls II:
  ...
  exclude_locations: 
    ...
    [
      # Exclude all side areas
      "Cathedral of Blue",
      "Undead Purgatory",
      "Belfry Luna", "Belfry Sol",
      "Doors of Pharros", "Grave of Saints",
      "Dragon Aerie",
      "Memory of Vammar", "Memory of Orro",
      # Exclude complex areas that require multiple passes.
      "The Pit", "The Gutter", "Brightstone Cove Tseldora"
    ]
```
